...
{ 
  ...
  //srand(time(NULL)); //what happens withot the seed value? ... always the same random number
  srand(1); //what happens withot the seed value? ... always the same random number
